...
<table class="border" width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
  <tr>
    <td height="565" align="center" valign="top" class="bg_low"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="middle" class="bgtop"><font color=""><b>书籍列表</b></font> </td>
      </tr>
    </table>
<TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=1  bordercolor="#33CCCC">
  <TBODY>
			  ...
			  <td>序号 </td>
					         ...
					         <td width="9%" height="25"><strong>书籍名称</strong></td>
			
					         <td width="9%" height="25"><strong>分类</strong></td>
			
					         <td width="9%" height="25"><strong>作者</strong></td>
			
					         <td width="9%" height="25"><strong>出版社</strong></td>
			
					
			
					         <td width="9%" height="25"><strong>图片</strong></td>
			
					
			
					         <td width="9%" height="25"><strong>浏览量</strong></td>
			
					         <td width="9%" height="25"><strong>上架</strong></td>
	  ...
	  <c:forEach items="${mylist}" var="mymap" varStatus="status">  
              <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"' onmouseout='this.style.background="#FFFFFF"'>
                ...
                <td ><a href="<%= request.getContextPath()%>/shuji/del?keyid=${mymap.sjid}"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|
<a href="<%= request.getContextPath()%>/shuji/modify?keyid=${mymap.sjid}"  >修改</a>|<a href="<%= request.getContextPath()%>/shuji/detail?keyid=${mymap.sjid}"  >详情</a></td>
