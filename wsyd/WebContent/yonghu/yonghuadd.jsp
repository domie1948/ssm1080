...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  <TBODY>
     ...
     <td ><input type="text"   name="zcsj" placeholder="输入注册时间"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="<%=StaticMethod.getStringDate()%>"  /><i>	 <font color="red">*</font> </i></li></td>
	 
	 </tr>
         <tr>
     <td align=middle width=30% height=30>联系电话:</td>
     <td ><input type="text"   name="lxdh" placeholder="输入联系电话"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
	 
	 </tr>
         <tr>
     <td align=middle width=30% height=30>联系地址:</td>
     <td ><input type="text"   name="lxdz" placeholder="输入联系地址"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
     ...
     <td ><input type="text"   name="ah" placeholder="输入爱好"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value=""  /><i>	 <font color="red">*</font> </i></li></td>
