...
<TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=1  bordercolor="#33CCCC">
  <TBODY>
			  ...
			  <td>序号 </td>
					         ...
					         <td width="9%" height="25"><strong>权限</strong></td>
			
					         <td width="9%" height="25"><strong>注册时间</strong></td>
					         ...
					         <td width="9%" height="25"><strong>爱好</strong></td>
	  ...
	  <c:forEach items="${mylist}" var="mymap" varStatus="status">  
              <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"' onmouseout='this.style.background="#FFFFFF"'>
			          <td  align="center" height="28" >${status.count}</td>
					        ...
					        <td  align="center" height="28">${mymap.qx}</td>
					        <td  align="center" height="28">${mymap.zcsj}</td>
					        ...
					        <td  align="center" height="28">${mymap.ah}</td>
