...
<table class="border" width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
  <tr>
    <td height="565" align="center" valign="top" class="bg_low"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="middle" class="bgtop"><font color=""><b>收藏列表</b></font> </td>
      </tr>
    </table>
  ...
  <TBODY>
	  ...
	  <c:forEach items="${mylist}" var="mymap" varStatus="status">  
              <tr align='center' bgcolor='#FFFFFF' onmouseover='this.style.background="#F2FDFF"' onmouseout='this.style.background="#FFFFFF"'>
                ...
                <td ><a href="<%= request.getContextPath()%>/shouzang/del?keyid=${mymap.szid}"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}">删除</a>|
<a href="<%= request.getContextPath()%>/shouzang/modify?keyid=${mymap.szid}"  >修改</a>|<a href="<%= request.getContextPath()%>/shouzang/detail?keyid=${mymap.szid}"  >详情</a></td>
