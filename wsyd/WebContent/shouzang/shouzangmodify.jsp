...
form.action="<%=request.getContextPath()%>/shouzang/update";
form.submit();
}
</script>
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  <TBODY>
     ...
     <td ><input type="text"   name="shj" placeholder="输入书籍"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${shj}"    /><i>	 <font color="red">*</font> </i></li></td>
     ...
     <td ><input type="text"   name="sj" placeholder="输入时间"  class="input" style="FONT-SIZE: 12px; WIDTH: 300px"  value="${sj}"    /><i>	 <font color="red">*</font> </i></li></td>
  	     ...
  	     <input type="hidden" name="szid" value="${szid}">
</TBODY></TABLE>
</div>
