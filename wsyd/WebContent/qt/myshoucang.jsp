...
String sql="select a.*,b.sjmc from shouzang a,shuji b where 1=1 and a.shj=b.sjid ";//查询 收藏sql语句
...
<div class="ty">
<div class="ty_title">
<div class="title_left"><font color="#0000FF" size="3"><b>我的收藏</b></font></div>
...
<td > <a href="shouzangdelete.jsp?keyid=<%=rs.getString("szid")%>"   onClick="javascript:if(confirm('是否删除')){return true;}else{return false;}">删除</a>|<a href="shujidetail.jsp?keyid=<%=rs.getString("shj")%>">查看</a></td>
</tr>
