...
String sql="select a.*,c.sjmc,b.zj as zjm from shuqian a,zhangjie b,shuji c where 1=1 and a.zj=b.zjid and b.sj=c.sjid  ";//查询 收藏sql语句
...
<div class="ty">
<div class="ty_title">
<div class="title_left"><font color="#0000FF" size="3"><b>书签</b></font></div>
...
<ul>
 ...
 <td height="24" ><%=rs.getString("zjm")%>[<%=rs.getString("sjmc")%>]</td>
